...
这里生成的是`3752c6169c8466f2863ecf99eae53a3e6a0b77c7@127.0.0.1.json`, 其内容如下:
```
{
...
$ qosd gentx --moniker TestNode --owner test01 --tokens 1000
Password to sign with 'test01':
ERROR: open \.qosd\config\gentx\3752c6169c8466f2863ecf99eae53a3e6a0b77c7@127.0.0.1.json: The file exists.
```