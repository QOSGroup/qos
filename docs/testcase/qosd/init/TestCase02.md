...
{
 "moniker": "testnet",
 "chain_id": "test-chain-4AgpL3",
 "node_id": "34a711008bfcba503a105aa3511eaec98613eb43",
 "gentxs_dir": "",
 "app_message": {
  "gen_txs": null,
  "accounts": null,
...
```
$ qosd init --moniker testnet
ERROR: genesis.json file already exists: \.qosd\config\genesis.json
```