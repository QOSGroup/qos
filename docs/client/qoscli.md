...
`qoscli tx create-validator --name <validator_name> --owner <key_name_or_account_address> --pubkey <validator_pubkey> --tokens <tokens>`
...
```bash
$ qoscli tx create-validator --name "Arya's node" --owner Arya --pubkey VOn2rPx+t7Njdgi+eLb+jBuF175T1b7LAcHElsmIuXA= --tokens 1000
```
