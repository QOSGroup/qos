...
func RegisterCodec(cdc *amino.Codec) {
	...
	cdc.RegisterConcrete(&gtypes.AddInflationPhraseProposal{}, "gov/AddInflationPhraseProposal", nil)
	cdc.RegisterConcrete(&TxParameterChange{}, "gov/txs/TxParameterChange", nil)
	cdc.RegisterConcrete(&TxAddInflationPhrase{}, "gov/txs/TxAddInflationPhrase", nil)
