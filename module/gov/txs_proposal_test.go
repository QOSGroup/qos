...
func defaultContext() context.Context {
	...
	cms.MountStoreWithDB(paramsKey, store.StoreTypeIAVL, db)
	cms.MountStoreWithDB(validatorKey, store.StoreTypeIAVL, db)
	cms.MountStoreWithDB(delegatorKey, store.StoreTypeIAVL, db)
	cms.MountStoreWithDB(guardianKey, store.StoreTypeIAVL, db)
	cms.MountStoreWithDB(distributionKey, store.StoreTypeIAVL, db)
